...
export default function ProductTypePage() {
  ...
  //   { id: 4, name: 'Cardigan', image: '/ProductTypeCardigan.svg' },
  //   { id: 5, name: 'Shrug', image: '/ProductTypeShurg.svg' },
  //   { id: 6, name: 'Skirt', image: '/ProductTypeSkirt.svg' },
  //   { id: 7, name: 'Overalls', image: '/ProductTypeOveralls.svg' },
  //   { id: 8, name: 'Blouse', image: '/ProductTypeBlouse.svg' },
  //   { id: 9, name: 'Kurta', image: '/ProductTypeKurta.svg' },
  //   { id: 10, name: 'Dress', image: '/ProductTypeDress.svg' },
  // ];
